...
class Tests_Boilerplate_Setup extends WP_UnitTestCase {
	...
	{
		$this->assertTrue( class_exists( 'TutorPlugin' ), 'The plugin was loaded' );
	}
	
	
	function test_environment()
	{
		$Boilerplate = TutorPlugin::bootstrap();
	...
	function test_load_lib()
	{
		...
		$this->assertTrue( $lib instanceof TutorPlugin_Controller_Settings, 'lib is instance of the correct class' );
